...
def load_real_time_data():
    ...
    data_file = Path("/home/candfpi4b/fresh_repo/legoml/inference/dashboard_data.json")
...
def load_latest_snapshots(limit=5):
    ...
    snapshots_dir = Path("/home/candfpi4b/fresh_repo/legoml/inference/snapshots")
...
def render_dashboard_content():
    ...
    # Main content
    if not Path("/home/candfpi4b/fresh_repo/legoml/inference/snapshots").exists():
